  ...
  const items = [
    {
      ...
      stars: "★★★★★",
      text: "The KisaanSetu platform has completely transformed the way I approach agricultural data analysis. The AI-driven insights are accurate, user-friendly, and truly empowering for farmers. I’m thrilled to use this tool that’s making a real difference in sustainable agriculture!",
      name: "- Arjun Sharma",
    ...
    },
    {
      ...
      stars: "★★★★",
      text: "Working with KisaanSetu has opened new possibilities for crop management. The platform’s predictive models help me recommend tailored solutions for farmers, which they find incredibly helpful. The entire experience has made my job easier and much more impactful!",
      name: "- Priya Desai",
      jobTitle: "Agronomist",
    ...
    },
    {
      ...
      stars: "★★★★★",
      text: "KisaanSetu’s pest control recommendations have been a game-changer for our farm. We can now manage pests more effectively and sustainably. The platform’s easy-to-use tools are perfect for any farm size. It’s a must-have for anyone in agriculture!",
      name: "- Rohan Patel",
    ...
    },
    {
      ...
      stars: "★★★★",
      text: "KisaanSetu is an invaluable resource for managing soil health. The insights on nutrient levels and soil quality have helped me guide farmers toward healthier crops and improved yields. It’s a must-use tool for anyone serious about sustainable farming!",
      name: "- Neha Iyer",
    ...
    },
    {
      ...
      stars: "★★★★★",
      text: "The KisaanSetu platform has been an amazing resource for understanding climate impact on crops. I can now make informed decisions based on weather predictions and irrigation insights a noticeable difference in crop health and yield.",
      name: "- Rahul Singh",
    ...
    },
    {
      img: "https://www.gravatar.com/avatar/2c7d99fe281ecd3bcd65ab915bac6dd5?s=250",
      stars: "★★★★★",
      text: "KisaanSetu has been an outstanding tool for improving our pest control strategies. With data-backed recommendations, we’ve reduced pesticide use and achieved better crop health. The platform is incredibly insightful!",
      name: "- Kavita Nair",
