      ...
      <div className="max-w-3xl mx-auto bg-white shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="px-6 py-8 space-y-8">
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              All intellectual property rights in our software and services, including but not limited to, trademarks, logos, and proprietary information, remain the sole property of KisaanSetu.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="text-gray-700 leading-relaxed">
              If you have any questions or concerns about this Licensing Agreement, please contact us.
            </p>
