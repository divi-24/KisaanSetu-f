...
const ForgotPasswordPage = () => {
  ...
  const handleSendOtp = async () => {
    try {
      await axios.post("https://KisaanSetu-ai-11j3.onrender.com/auth/forgot-password", { email });
  ...
  const handleVerifyOtp = async () => {
    try {
      await axios.post("https://KisaanSetu-ai-11j3.onrender.com/auth/verify-otp", { email, otp });
  ...
  const handleResetPassword = async () => {
    try {
      await axios.post("https://KisaanSetu-ai-11j3.onrender.com/auth/reset-password", { email, otp, newPassword });
