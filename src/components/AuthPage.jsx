...
const AuthPage = () => {
  ...
  const handleSignUp = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://KisaanSetu-ai-11j3.onrender.com/auth/signup", {
        firstName,
        lastName,
        email,
        password,
  ...
  const handleSignIn = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post("https://KisaanSetu-ai-11j3.onrender.com/auth/signin", {
        email,
        password,
      });
      setMessage(response.data.message);
