...
const Footer = () => {
    ...
    const socialMedia = [
        { Icon: FaGithub, link: 'https://github.com/divi-24/', color: '#333' },
        { Icon: FaLinkedinIn, link: 'https://www.linkedin.com/in/deepakgupta249/', color: '#0077B5' },
    ];
            ...
            <div className='container mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
                    ...
                    <div className="space-y-4">
                        <Link to="/" className="flex items-center gap-2 group transition-all duration-300 ease-in-out transform hover:scale-105">
                            <img src={playstore} className="h-10 w-10 transition-transform duration-300 group-hover:rotate-12" alt="KisaanSetu Logo" />
                        ...
                        <p className="text-sm leading-relaxed max-w-xs">
                            KisaanSetu platform provides cutting-edge Machine Learning models for agricultural predictions and insights.
                        </p>
                    </div>
                ...
                <div className='mt-8 pt-8 border-t border-white/30 text-center'>
                    <p className='flex items-center justify-center text-sm'>
                        Copyright <FaRegCopyright className='mx-1' /> {currentYear} All Rights Reserved <span className="font-bold ml-2 bg-white text-emerald-600 px-2 py-1 rounded transition-all duration-300 hover:bg-emerald-600 hover:text-white">KisaanSetu</span>
                    </p>
                </div>
