...
function ChatBot() {
  ...
  const sendMessage = async (prompt) => {
    ...
    try {
      const response = await fetch('https://kisaansetu-api-luyc.onrender.com/chatbot', {
        method: 'POST',
    ...
    >
      <div className="w-full max-w-4xl bg-white bg-opacity-80 backdrop-blur-md shadow-xl rounded-lg overflow-hidden">
        <div className="border-b border-green-200 p-4">
          <h1 className="text-3xl font-bold text-green-800 text-center">KisaanSetu ChatBot</h1>
        </div>
        <div className="p-6">
        ...
        <div className="border-t border-green-200 p-4">
          <div className="flex w-full items-center space-x-2">
            <input
              ...
              placeholder="Ask KisaanSetu-AI ChatBot..."
