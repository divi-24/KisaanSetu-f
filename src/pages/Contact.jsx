...
const Contact = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "KisaanSetu primarily serves the agricultural industry, helping farmers and researchers make data-driven decisions.",
    },
  ];
  ...
  const socialMedia = [
    ...
    { Icon: FaLinkedin, link: 'https://www.linkedin.com/in/deepakgupta249/', color: '#0077B5' },
  ];
    ...
    >
      ...
      <div className='flex w-full'>
        ...
        <div>
          ...
          <div className="bg-green-100 p-6 rounded-lg shadow-md max-w-4xl mx-auto mb-10">
            ...
            <p>"KisaanSetu has revolutionized our farming processes! Their predictive models help us optimize crop yield and reduce wastage." - Farmer John</p>
            <p>"The insights provided by KisaanSetu are invaluable for making data-driven decisions on the field." - Dr. Smith, Agronomist</p>
          </div>
      ...
      <div className='flex flex-col'>
        <div className="flex justify-center space-x-4 mb-10">
          <a
            href="mailto:info@KisaanSetu.com"
